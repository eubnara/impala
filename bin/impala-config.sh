...
export APACHE_HBASE_VERSION=2.4.9 # hadoop-ozone-filesystem-hadoop3  1.1.0 depends on hbase 2.4.9
export APACHE_ICEBERG_VERSION=0.14.1
export APACHE_KNOX_VERSION=1.6.1
export APACHE_OZONE_VERSION=1.1.0
export APACHE_PARQUET_VERSION=1.12.3
export APACHE_RANGER_VERSION=2.3.0
export APACHE_TEZ_VERSION=0.10.1
export APACHE_GCS_VERSION=hadoop3-2.1.2
...
if ${USE_APACHE:=false}; then
  ...
  export IMPALA_GCS_VERSION=${APACHE_GCS_VERSION}
...
if ${USE_APACHE_HADOOP:-false}; then
...
if ${USE_APACHE_HBASE:-false}; then
...
if ${USE_APACHE_RANGER:-false}; then
